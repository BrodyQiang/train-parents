...
public enum SeatTypeEnum {
    ...
    SWZ("01", "商务座", new BigDecimal("0.4")),
    YDZ("02", "一等座", new BigDecimal("0.4")),
    EDZ("03", "二等座", new BigDecimal("0.3")),
    YZ("04", "硬座", new BigDecimal("0.6")),
    RW("05", "软卧", new BigDecimal("0.6")),
    YW("06", "硬卧", new BigDecimal("0.5"));
